...
For each of the selected assets, a trade will be taken in a given time-step, if the absolute value of predicted residual exceeds the corresponding fixed cost at least by a specified buffer. The following fixed cost components are considered:
